...
<body>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark"
    style="position:fixed; height:100vh; width: 280px;">
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
      <svg class="bi me-2" width="40" height="32">
        <use xlink:href="#bootstrap" />
      </svg>
      <span class="fs-4">stockSmart</span>
    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto" id="sidebar-links">
      ...
      <li>
        <a href="./pkg_mtrl.php" class="nav-link text-white">
          <svg class="bi me-2" width="16" height="16">
            <use xlink:href="#grid" />
          </svg>
          Packaging Materials
    ...
    <div class="dropdown">
      <a href="" class="d-flex align-items-center text-white text-decoration-none " id="dropdownUser1"
        ...
        <img src="./assets/shoes.jpg" alt="" width="32" height="32" class="rounded-circle me-2">
        <strong>
          <?php
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      var targetLink = document.querySelector('#sidebar-links a[href="' + path + '"]');
      if (targetLink) {
